...
public class AsynchronousClient
{
    ...
    private static void StartClient()
    {
        ...
        try
        {
            ...
            var bytes = Serializers.ObjectToByteArray(message);
            Console.WriteLine("Message size: {0}", bytes.Length);
    ...
    private static void ReceiveCallback(IAsyncResult ar)
    {
        try
        {
            ...
            } else
            {
                ...
                {
                    response = Serializers.ByteArrayObject<RegisterResponse>(state.byteBuffer.ToArray());
                }
